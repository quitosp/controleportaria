...
public class SalvarVeiculoEntrada : Comand
{
    ...
    {
        ValidationResult = new SalvarVeiculoValidation().Validate(this);
        return ValidationResult.IsValid;
    }

    public class SalvarVeiculoValidation : AbstractValidator<SalvarVeiculoEntrada>
    {
        public SalvarVeiculoValidation()
        {
